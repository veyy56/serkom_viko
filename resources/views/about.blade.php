      ...
      <div class="col-12 col-lg-6 col-xl-7">
        <div class="row justify-content-xl-center">
          <div class="col-12 col-xl-11">
            ...
            <p class="lead fs-2 text-secondary mb-3">Selamat datang di dunia kenyamanan</p>
            <p class="mb-5">Di Hotel Indah ini, kami tidak hanya menawarkan tempat menginap yang nyaman, tetapi juga pengalaman tak terlupakan yang akan membuat Anda kembali lagi dan lagi. Terletak di pusat kota yang sibuk, hotel kami menawarkan kemewahan modern yang dipadukan dengan keramahan lokal yang hangat.</p>
            <div class="row gy-4 gy-md-0 gx-xxl-5X">
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  ...
                  <div>
                    <h2 class="h4 mb-3">Hubungi Kami</h2>
              ...
              <div class="col-12 col-md-6">
                <div class="d-flex">
                  ...
                  <div>
                    <h2 class="h4 mb-3">Alamat Hotel</h2>
                    <p class="text-secondary mb-0">Jl. Dr. Angka No.71, Karangkobar, Sokanegara, Kec. Purwokerto Tim., Kabupaten Banyumas, Jawa Tengah 53115</p>
                  </div>
                </div>
              </div>
            </div>
